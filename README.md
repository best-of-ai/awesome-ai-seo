...
* **[PageGuard](https://pageguard.qiudeqiu.workers.dev)** – Free AI-powered website health scanner. Runs Lighthouse audits (SEO, performance, accessibility, best practices) and generates AI action plans with natural language recommendations. Includes a CORS-enabled REST API for developers.
